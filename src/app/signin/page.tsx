...
const Page = () => {
    ...
    const handleUserMailInput = (event: ChangeEvent<HTMLInputElement>) => {
        setemailUsernameInput(event.target.value);
        console.log(emailUsernameInput)
    }
    ...
    return (
        <>
        <div className="flex place-items-center mb-[40px] w-[430px] h-[707px] bg-black">
        <div className="w-[430px] h-[400px] bg-black flex-col place-items-center">
        <div className="mt-7">
      ...
      <Button onClick={logIn} className="w-[270px] bg-blue-500 opacity-70">Log In</Button>
      </div>
        <div className="h[24px]">
        <p className="text-white">Don't have an account?
             <span onClick={changeRegion} className="text-blue-600"> Sign up</span>
        </p>
        </div>
        </div>
        </div>
