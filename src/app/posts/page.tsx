...
const Page = () => {
    ...
    return (
        ...
        <div className="m-0 p-0">
            {posts.map((post =>
            <Card className="flex py-5 w-[430px] rounded-none h-[523px]  object-fill border-none bg-black" key={post._id}>
                <CardContent className="flex-col w-[430px] rounded-none h-[535px] p-0 bg-black ">
